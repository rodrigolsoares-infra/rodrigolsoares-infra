...
Este projeto consiste na implementação e simulação de uma infraestrutura de rede local para uma pequena empresa fictícia (*TechCorp*), utilizando o Cisco Packet Tracer.
